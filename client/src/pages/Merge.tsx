            ...
            <main className="flex-grow pt-32 pb-20 px-4">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="text-center mb-10">
                        <div className={`w-20 h-20 bg-blue-50 text-primary rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-soft transition-all duration-700 ${mount ? 'opacity-100 scale-100 rotate-3' : 'opacity-0 scale-50 rotate-12'}`}>
                            <Layers className="w-10 h-10" />
                        </div>
                        <h1 className={`text-4xl lg:text-5xl font-bold mb-4 text-text-main transition-all duration-700 delay-100 ${mount ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>Merge PDFs</h1>
                        <p className={`text-lg text-text-body font-medium transition-all duration-700 delay-200 ${mount ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>Combine multiple documents into one master file.</p>
                    </div>
